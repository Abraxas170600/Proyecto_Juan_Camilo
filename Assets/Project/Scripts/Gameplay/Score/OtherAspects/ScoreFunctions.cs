...
public class ScoreFunctions : MonoBehaviour
{
    ...
    {
        _playerManager._currentScore += _playerManager._playerDatabase._score[_playerManager._playerDatabase._player[_playerManager.indexPlayer]._playerData._id]._scoreData._scoreAmount;
        CheckScore();
    } 
